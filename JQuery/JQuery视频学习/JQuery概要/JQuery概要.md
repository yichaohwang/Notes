...
- [day01 - jQuery](#day01---jquery)
  - [1.1. jQuery 介绍](#11-jquery-介绍)
    - [1.1.1 JavaScript 库](#111-javascript-库)
    - [1.1.2 jQuery的概念](#112-jquery的概念)
    - [1.1.3 jQuery的优点](#113-jquery的优点)
  - [1.2. jQuery 的基本使用](#12-jquery-的基本使用)
    - [1.2.1 jQuery 的下载](#121-jquery-的下载)
    - [1.2.2. 体验jQuery](#122-体验jquery)
    - [1.2.3. jQuery的入口函数](#123-jquery的入口函数)
    - [1.2.4. jQuery中的顶级对象$](#124-jquery中的顶级对象)
    - [1.2.5.  jQuery 对象和 DOM 对象](#125--jquery-对象和-dom-对象)
    - [1.2.6.  jQuery 对象和 DOM 对象转换](#126--jquery-对象和-dom-对象转换)
  - [1.3. jQuery 选择器](#13-jquery-选择器)
    - [1.3.1. 基础选择器](#131-基础选择器)
    - [1.3.2. 层级选择器](#132-层级选择器)
    - [1.3.3. 筛选选择器](#133-筛选选择器)
    - [1.3.4 知识铺垫](#134-知识铺垫)
    - [1.3.5 案例：淘宝服饰精品案例](#135-案例淘宝服饰精品案例)
  - [1.4.  jQuery 样式操作](#14--jquery-样式操作)
    - [1.4.1. 方法1: 操作 css 方法](#141-方法1-操作-css-方法)
    - [1.4.2. 方法2: 设置类样式方法](#142-方法2-设置类样式方法)
    - [1.4.3. 案例：tab 栏切换](#143-案例tab-栏切换)
  - [1.5. jQuery 效果](#15-jquery-效果)
    - [1.5.1. 显示隐藏](#151-显示隐藏)
    - [1.5.2. 滑入滑出](#152-滑入滑出)
    - [1.5.3 淡入淡出](#153-淡入淡出)
    - [1.5.4 自定义动画](#154-自定义动画)
    - [1.5.5 停止动画排队](#155-停止动画排队)
    - [1.5.6. 事件切换](#156-事件切换)
    - [1.5.7. 案例：王者荣耀手风琴效果](#157-案例王者荣耀手风琴效果)
  - [1.6. 今日总结](#16-今日总结)
